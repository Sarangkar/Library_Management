<%@ Page Title="Library Management System" Language="C#" MasterPageFile="~/Admin/AdminSite.Master" AutoEventWireup="true" CodeBehind="Book.aspx.cs" Inherits="Library_Management.Admin.Book" %>
            ...
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col">
                        <center>
                           <img id="imgview" Height="150px" Width="100px" src="../Books_img/books.jpg" />
                        </center>
                     </div>
                  </div>
                  <div class="row">
                     ...
                     <div class="col-md-4 mb-3">
                        ...
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="TextBox10" runat="server" placeholder="Book Cost(per unit)" TextMode="Number"></asp:TextBox>
                                              <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*Enter Book Cost" Display="Dynamic" ControlToValidate="TextBox10" ForeColor="Red" SetFocusOnError="True"></asp:RequiredFieldValidator>
                     ...
                     <div class="col-md-4 mb-3">
                        ...
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="TextBox11" runat="server" placeholder="Pages" TextMode="Number"></asp:TextBox>
                                                                          <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="*Enter Pages" Display="Dynamic" ControlToValidate="TextBox11" ForeColor="Red" SetFocusOnError="True"></asp:RequiredFieldValidator>
                     ...
                     <div class="col-md-4 mb-3">
                        ...
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="TextBox4" runat="server" placeholder="Actual Stock" TextMode="Number"></asp:TextBox>
                                                                                                  <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="*Enter Actual Stock" Display="Dynamic" ControlToValidate="TextBox11" ForeColor="Red" SetFocusOnError="True"></asp:RequiredFieldValidator>
         ...
         <div class="col-md-6">
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                      <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Library_ManagementConnectionString %>" SelectCommand="SELECT * FROM book_master_tbl"></asp:SqlDataSource>
                     <div class="col">
